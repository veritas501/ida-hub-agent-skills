...
Each pattern follows the **Collect → Filter → Aggregate → Summarize** pipeline
and demonstrates output budget control.

Use these as starting points — adapt the filter/aggregate logic to your task.
