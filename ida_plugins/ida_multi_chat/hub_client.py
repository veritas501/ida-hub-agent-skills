...
from .ida_config import decode_ida_config
...
class HubConfig:
    ...
    @property
    def host(self) -> str:
        return str(decode_ida_config(self.config_string)["host"])

    @property
    def port(self) -> int:
        return int(decode_ida_config(self.config_string)["port"])

    @property
    def token(self) -> str:
        return str(decode_ida_config(self.config_string)["token"])
...
class IDAHubClient:
    ...
    def _build_ws_url(self) -> str:
        ...
        return f"ws://{self._config.host}:{self._config.port}/ws?token={self._config.token}"
